...
const tuningFields: Array<{ key: NumericSceneTuningKey; label: string; min: number; max: number; step: number }> = [
  ...
  { key: 'sceneCanvasScale', label: 'Canvas Width Scale', min: 1, max: 2.6, step: 0.05 },
  { key: 'sceneCanvasHeightScale', label: 'Canvas Height Scale', min: 0.7, max: 2.6, step: 0.05 },
  { key: 'sceneCutoffExtensionPx', label: 'Canvas Cutoff Extension (px)', min: -300, max: 500, step: 5 },
