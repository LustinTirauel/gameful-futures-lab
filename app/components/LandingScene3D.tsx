...
export const defaultSceneTuning: SceneTuning = {
  ...
  sceneRadius: 40,
  characterOverrides: {
    alex: { x: -1.95, y: -0.2, z: -2.95, scale: 1, rotX: 0, rotY: 0.37, rotZ: 0.17 },
    bea: { x: -2.3640615897, y: -0.2, z: -0.869687798, scale: 1, rotX: 0.02, rotY: -0.02, rotZ: 0.1 },
    chen: { x: -0.333366199, y: -0.15, z: 0.6224270881, scale: 1, rotX: 0, rotY: -0.23, rotZ: 0 },
    dina: { x: -0.4486082757, y: -0.05, z: -0.142342924, scale: 0.81, rotX: -0.38, rotY: 0.94, rotZ: 0.31 },
    eli: { x: 1.1146176522, y: -0.15, z: -1.2981786335, scale: 0.76, rotX: 0.13, rotY: 2.01, rotZ: 0.01 },
  },
  fireOverride: {
    x: -0.1009196756,
    y: -0.3,
